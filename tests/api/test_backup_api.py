...
class TestBackupAPI:
    ...
    async def test_restore_merge(self, async_client: AsyncClient, auth_headers_admin, db_session):
        ...
        UserFactory.create(
            username="existing_user", email="existing@test.com", role=UserRole.MEMBER
        )
        db_session.commit()
    ...
    @pytest.mark.asyncio
    async def test_restore_replace_no_confirm(self, async_client: AsyncClient, auth_headers_admin):
    ...
    @pytest.mark.asyncio
    async def test_restore_regular_user_denied(self, async_client: AsyncClient, auth_headers_user):
    ...
    @pytest.mark.asyncio
    async def test_restore_invalid_file(self, async_client: AsyncClient, auth_headers_admin):
    ...
    @pytest.mark.asyncio
    async def test_restore_invalid_gzip(self, async_client: AsyncClient, auth_headers_admin):
    ...
    @pytest.mark.skip(
        reason="Replace mode needs PRAGMA foreign_keys=OFF on in-memory SQLite — works on file-based DBs"
    )
    @pytest.mark.asyncio
